...
## Step 1: Forking and Installing pytorch_fasterrcnn
...
pytorch_fasterrcnn repo.

​2. Download a copy of your remote username/pytorch_fasterrcnn repo to your
...
1.  Set the upstream to sync with this repo. This will keep you in sync
    with pytorch_fasterrcnn easily.

```bash
$ git remote add upstream https://github.com/oke-aditya/pytorch_fasterrcnn.git
```
...
command, from the pytorch_fasterrcnn folder:
...
(github.com/username/pytorch_fasterrcnn)
...
pytorch_fasterrcnn main repo and GitHub will prompt you to create a pull
request.

#### 2. Confirm PR was created:

Ensure your pr is listed
[here](https://github.com/oke-aditya/pytorch_fasterrcnn/pulls)
...
> **note**
>
> pytorch_fasterrcnn repository has CI checking. It will automatically check your code
> for build as well.
